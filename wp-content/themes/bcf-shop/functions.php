...
function bcf_shop_custom_header_args( $args ) {

	$args['default-image'] = get_stylesheet_directory_uri() . '/images/custom-header.jpg';
   return $args;
}
add_filter( 'business_consultant_finder_custom_header_args', 'bcf_shop_custom_header_args', 10, 3 );